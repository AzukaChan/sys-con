...
all: build
	rm -rf $(OUT_DIR)
	mkdir -p $(OUT_DIR)/sxos/titles/690000000000000D/flags
	mkdir -p $(OUT_DIR)/config/sys-con
	mkdir -p $(OUT_DIR)/switch/
	touch $(OUT_DIR)/sxos/titles/690000000000000D/flags/boot2.flag
	cp $(SOURCE_DIR)/Sysmodule/sys-con.nsp $(OUT_DIR)/sxos/titles/690000000000000D/exefs.nsp
